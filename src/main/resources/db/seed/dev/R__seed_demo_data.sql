-- Dev demo seed refreshed after V14/V15/V16 operational cleanup.
...
INSERT INTO wallet_ledger (
    ...
    ((SELECT wallet_id FROM wallets WHERE user_id = '11111111-1111-1111-1111-111111111111' LIMIT 1), '11111111-1111-1111-1111-111111111111', 'DEPOSIT', 'IN', 52650000, 52650000, 'SEED', 'seed-deposit-1', '초기 가상 투자금 지급', '2026-04-07 09:00:00.000000'),
    ((SELECT wallet_id FROM wallets WHERE user_id = '11111111-1111-1111-1111-111111111111' LIMIT 1), '11111111-1111-1111-1111-111111111111', 'BUY_SETTLEMENT', 'OUT', 700000, 51950000, 'ORDER', 'order-0001', '삼성전자 매수 체결', '2026-04-07 09:01:02.000000'),
    ((SELECT wallet_id FROM wallets WHERE user_id = '11111111-1111-1111-1111-111111111111' LIMIT 1), '11111111-1111-1111-1111-111111111111', 'BUY_SETTLEMENT', 'OUT', 1150000, 50800000, 'ORDER', 'order-0002', 'NAVER 매수 체결', '2026-04-07 09:02:02.000000'),
    ((SELECT wallet_id FROM wallets WHERE user_id = '11111111-1111-1111-1111-111111111111' LIMIT 1), '11111111-1111-1111-1111-111111111111', 'BUY_SETTLEMENT', 'OUT', 800000, 50000000, 'ORDER', 'order-0003', 'LG에너지솔루션 매수 체결', '2026-04-07 09:03:02.000000');
...
INSERT INTO user_squad_memberships (user_id, squad_id, joined_at, updated_at) VALUES
    ('11111111-1111-1111-1111-111111111111', 'squad-1', '2026-04-07 09:00:00.000000', '2026-04-07 09:00:00.000000');

INSERT INTO user_challenge_progress (user_id, challenge_id, status, completed_at, created_at, updated_at) VALUES
    ('11111111-1111-1111-1111-111111111111', 'challenge-squad', 'completed', '2026-04-07 09:00:00.000000', '2026-04-07 09:00:00.000000', '2026-04-07 09:00:00.000000');
